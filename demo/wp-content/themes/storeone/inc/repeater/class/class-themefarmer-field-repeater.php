...
class ThemeFarmer_Field_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script('themefarmer-iconpicker', get_template_directory_uri() . '/inc/repeater/js/themefarmer-iconpicker.js', array('jquery'), null, true);
		wp_enqueue_script('themefarmer-field-repeater', get_template_directory_uri() . '/inc/repeater/js/themefarmer-field-repeater.js', array('jquery', 'jquery-ui-sortable', 'jquery-ui-draggable', 'wp-color-picker'), null, true);
	}
